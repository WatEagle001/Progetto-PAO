...
auto_ibrida::auto_ibrida(std::string _marca, std::string _modello, std::string _paese, std::string _descrizione, double _rapp_peso_pot, unsigned int _cavalli, unsigned int _peso, unsigned int _nm, unsigned int _cilindrata, unsigned int _cilindri, unsigned int _litri_serbatoio, alimentazione _carburante, unsigned int _cv_fiscali, unsigned int _kw_batteria):
