...
auto_elettrica::auto_elettrica(string _marca, string _modello, string _paese, string _descrizione, double _rapp_peso_pot, unsigned int _cavalli, unsigned int _peso, unsigned int _nm, unsigned int _cv_fiscali, unsigned int _kw_batteria):
